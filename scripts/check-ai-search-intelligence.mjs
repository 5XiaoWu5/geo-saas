...
if (/CROSS JOIN items\s+ON CONFLICT/i.test(repository)) throw new Error("Optimization upsert needs WHERE TRUE before ON CONFLICT to avoid PostgreSQL parser ambiguity.");
