...
export function UserMenu() {
  ...
  return (
    <div className="flex shrink-0 items-center gap-1 rounded-2xl border border-white/10 bg-white/[0.04] px-1.5 py-1.5 sm:gap-3 sm:px-3 sm:py-2">
      ...
      <Button asChild variant="ghost" size="icon" aria-label="安全设置" className="hidden sm:inline-flex"><Link href="/profile/security"><ShieldCheck className="h-4 w-4" /></Link></Button>
