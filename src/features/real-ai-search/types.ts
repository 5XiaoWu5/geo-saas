...
export type ProviderConfigView = { id: string | null; provider: AISearchProviderType; enabled: boolean; configured: boolean; model: string; lastTestStatus: "SUCCEEDED" | "FAILED" | null; lastTestError: string | null; lastTestedAt: string | null; createdAt: string | null; updatedAt: string | null };
